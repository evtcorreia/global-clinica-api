...
class Pessoa extends Model
{
    ...
    protected $fillable = ['pessoa_nome', 'pessoa_sobrenome', 'pessoa_cpf','pessoa_rg','pessoa_pai','pessoa_mae', 'pessoa_mail', 'pessoa_login', 'pessoa_senha', 'enderecos_endereco_id'];
